...
var Icon$q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "32", height: "32", href: "/images/midas/logo.png" })));
};
...
var Icon$v = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/midas/9.png" })));
};
...
var SpinnerIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("image", { width: "96", height: "96", href: "/images/midas/loading.png" })));
};
...
var Icon$R = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("defs", null,
            React.createElement("image", { width: "24", height: "24", id: "img8", href: "data:image/png;base64," })),
        React.createElement("use", { id: "Background", href: "#img8", x: "0", y: "0" })));
};

var Icon$S = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 14 27" }, props),
        React.createElement("defs", null,
            React.createElement("image", { width: "14", height: "27", id: "img3", href: "data:image/png;base64," })),
        React.createElement("use", { id: "Background", href: "#img3", x: "0", y: "0" })));
};
...
var Icon$Z = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("defs", null,
            React.createElement("image", { width: "24", height: "24", id: "img6", href: "data:image/png;base64," })),
        React.createElement("use", { id: "Background", href: "#img6", x: "0", y: "0" })));
};

var Icon$_ = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("defs", null,
            React.createElement("image", { width: "24", height: "24", id: "img5", href: "data:image/png;base64," })),
        React.createElement("use", { id: "Background", href: "#img5", x: "0", y: "0" })));
};

var Icon$$ = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 20" }, props),
        React.createElement("defs", null,
            React.createElement("image", { width: "32", height: "20", id: "img7", href: "data:image/png;base64," })),
        React.createElement("use", { id: "Background", href: "#img7", x: "0", y: "0" })));
};

var Icon$10 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("defs", null,
            React.createElement("image", { width: "24", height: "24", id: "img9", href: "data:image/png;base64," })),
        React.createElement("use", { id: "Background", href: "#img9", x: "0", y: "0" })));
};

var Icon$11 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("defs", null,
            React.createElement("image", { width: "20", height: "18", id: "img10", href: "data:image/png;base64," })),
        React.createElement("use", { id: "Background", href: "#img10", x: "0", y: "0" })));
};
...
var WrapIconSub = styled.div(templateObject_2$c || (templateObject_2$c = __makeTemplateObject(["\n    position: absolute;\n    top: 16px;\n    left: 9px;\n"], ["\n    position: absolute;\n    top: 16px;\n    left: 9px;\n"])));
...
var templateObject_1$C, templateObject_2$d, templateObject_3$7, templateObject_4$2;
...
var Avatar = function (_a) {
    ...
    var icon = image ? (React.createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" })) : (React.createElement(Icon$1a, { width: "32px", height: "32px" }));
    if (isExternal) {
...
var BodyWrapper = styled.div(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["  position: relative;\n  display: flex;\n"], ["  position: relative;\n  display: flex;\n"])));
...
var FlexCustom3 = styled(Flex)(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n    position: absolute;\n    right: 250px;\n    a{\n      padding: 6px 20px;\n      margin: 0px auto;\n      color: #fff;\n      font-weight: 700;\n      border-radius: 20px;\n      font-size: 14px;\n      @media screen and (max-width: 500px){\n        display: none;\n      }\n    }\n"], ["\n    position: absolute;\n    right: 250px;\n    a{\n      padding: 6px 20px;\n      margin: 0px auto;\n      color: #fff;\n      font-weight: 700;\n      border-radius: 20px;\n      font-size: 14px;\n      @media screen and (max-width: 500px){\n        display: none;\n      }\n    }\n"])));
var FlexCustom4 = styled(Flex)(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n    position: absolute;\n    right: 350px;\n    a{\n      padding: 6px 20px;\n      margin: 0px auto;\n      color: #fff;\n      font-weight: 700;\n      border-radius: 20px;\n      font-size: 14px;\n      @media screen and (max-width: 500px){\n        display: none;\n      }\n    }\n"], ["\n    position: absolute;\n    right: 350px;\n    a{\n      padding: 6px 20px;\n      margin: 0px auto;\n      color: #fff;\n      font-weight: 700;\n      border-radius: 20px;\n      font-size: 14px;\n      @media screen and (max-width: 500px){\n        display: none;\n      }\n    }\n"])));
var FlexCustom5 = styled(Flex)(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n    position: absolute;\n    right: 450px;\n    a{\n      padding: 6px 20px;\n      margin: 0px auto;\n      color: #fff;\n      font-weight: 700;\n      border-radius: 20px;\n      font-size: 14px;\n      @media screen and (max-width: 500px){\n        display: none;\n      }\n    }\n"], ["\n    position: absolute;\n    right: 450px;\n    a{\n      padding: 6px 20px;\n      margin: 0px auto;\n      color: #fff;\n      font-weight: 700;\n      border-radius: 20px;\n      font-size: 14px;\n      @media screen and (max-width: 500px){\n        display: none;\n      }\n    }\n"])));
var FlexCustom6 = styled(Flex)(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n    position: absolute;\n    right: 550px;\n    a{\n      padding: 6px 20px;\n      margin: 0px auto;\n      color: #fff;\n      font-weight: 700;\n      border-radius: 20px;\n      font-size: 14px;\n      @media screen and (max-width: 500px){\n        display: none;\n      }\n    }\n"], ["\n    position: absolute;\n    right: 550px;\n    a{\n      padding: 6px 20px;\n      margin: 0px auto;\n      color: #fff;\n      font-weight: 700;\n      border-radius: 20px;\n      font-size: 14px;\n      @media screen and (max-width: 500px){\n        display: none;\n      }\n    }\n"])));
var FlexCustom7 = styled(Flex)(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n    position: absolute;\n    right: 650px;\n    a{\n      padding: 6px 20px;\n      margin: 0px auto;\n      color: #fff;\n      font-weight: 700;\n      border-radius: 20px;\n      font-size: 14px;\n      @media screen and (max-width: 500px){\n        display: none;\n      }\n    }\n"], ["\n    position: absolute;\n    right: 650px;\n    a{\n      padding: 6px 20px;\n      margin: 0px auto;\n      color: #fff;\n      font-weight: 700;\n      border-radius: 20px;\n      font-size: 14px;\n      @media screen and (max-width: 500px){\n        display: none;\n      }\n    }\n"])));
    ...
    return (React.createElement(Wrapper$1, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            ...
            React.createElement(FlexCustom5, null,
                React.createElement("a", { href: "https://bsc.valuedefi.io/#/vswap?outputCurrency=0x7c9Cb83c0e47D01Bb27EE14337EE9eB493E770A7&inputCurrency=bnb", target: "_blank" }, "Buy MDG4")),
            React.createElement(FlexCustom4, null,
                React.createElement("a", { href: "https://bsc.valuedefi.io/#/vswap?outputCurrency=0x5e8499d884b3086d0fc0c21423fc427e31b7382c&inputCurrency=bnb", target: "_blank" }, "Buy MDG3")),
...
var templateObject_1$H, templateObject_2$g, templateObject_3$8, templateObject_4$3, templateObject_5$1, templateObject_6, templateObject_7, templateObject_8, templateObject_9, templateObject_10, templateObject_11, templateObject_12, templateObject_13;
