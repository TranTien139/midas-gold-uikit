            ...
            return (React__default['default'].createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass }, isPushed &&
                entry.items.map(function (item) {
                    ...
                    return (React__default['default'].createElement(MenuEntry, { key: item.href, secondary: true, isActive: location.pathname !== "/" ? item.href.indexOf(location.pathname) !== -1 : item.href === location.pathname, style: { position: 'relative' } }, (item.href.indexOf('https://') === -1) ?
                        React__default['default'].createElement(MenuLink, { href: item.href, onClick: handleClick },
                            item.label,
                            " ",
...
styled__default['default'](Flex)(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n    position: absolute;\n    right: 450px;\n    a{\n      padding: 6px 20px;\n      margin: 0px auto;\n      color: #fff;\n      font-weight: 700;\n      border-radius: 20px;\n      font-size: 14px;\n      @media screen and (max-width: 500px){\n        display: none;\n      }\n    }\n"], ["\n    position: absolute;\n    right: 450px;\n    a{\n      padding: 6px 20px;\n      margin: 0px auto;\n      color: #fff;\n      font-weight: 700;\n      border-radius: 20px;\n      font-size: 14px;\n      @media screen and (max-width: 500px){\n        display: none;\n      }\n    }\n"])));
styled__default['default'](Flex)(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n    position: absolute;\n    right: 550px;\n    a{\n      padding: 6px 20px;\n      margin: 0px auto;\n      color: #fff;\n      font-weight: 700;\n      border-radius: 20px;\n      font-size: 14px;\n      @media screen and (max-width: 500px){\n        display: none;\n      }\n    }\n"], ["\n    position: absolute;\n    right: 550px;\n    a{\n      padding: 6px 20px;\n      margin: 0px auto;\n      color: #fff;\n      font-weight: 700;\n      border-radius: 20px;\n      font-size: 14px;\n      @media screen and (max-width: 500px){\n        display: none;\n      }\n    }\n"])));
styled__default['default'](Flex)(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n    position: absolute;\n    right: 650px;\n    a{\n      padding: 6px 20px;\n      margin: 0px auto;\n      color: #fff;\n      font-weight: 700;\n      border-radius: 20px;\n      font-size: 14px;\n      @media screen and (max-width: 500px){\n        display: none;\n      }\n    }\n"], ["\n    position: absolute;\n    right: 650px;\n    a{\n      padding: 6px 20px;\n      margin: 0px auto;\n      color: #fff;\n      font-weight: 700;\n      border-radius: 20px;\n      font-size: 14px;\n      @media screen and (max-width: 500px){\n        display: none;\n      }\n    }\n"])));
styled__default['default'](Flex)(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n    position: absolute;\n    right: 750px;\n    a{\n      padding: 6px 20px;\n      margin: 0px auto;\n      color: #fff;\n      font-weight: 700;\n      border-radius: 20px;\n      font-size: 14px;\n      @media screen and (max-width: 500px){\n        display: none;\n      }\n    }\n"], ["\n    position: absolute;\n    right: 750px;\n    a{\n      padding: 6px 20px;\n      margin: 0px auto;\n      color: #fff;\n      font-weight: 700;\n      border-radius: 20px;\n      font-size: 14px;\n      @media screen and (max-width: 500px){\n        display: none;\n      }\n    }\n"])));
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            ...
            React__default['default'].createElement(FlexCustom3, null,
                React__default['default'].createElement("a", { href: "https://exchange.pancakeswap.finance/#/swap?outputCurrency=0xC8bA297F22392A98a7f203D6fA40A56341C40CEB", target: "_blank" }, "Buy MDG6")),
            React__default['default'].createElement(FlexCustom2, null,
                React__default['default'].createElement("a", { href: "https://www.bdex.fi/#/swap?outputCurrency=0xc1edcc306e6faab9da629efca48670be4678779d", target: "_blank" }, "Buy MDG")),
